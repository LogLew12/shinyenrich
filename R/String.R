...
mapping_file <- paste0("assests:/i_data/", species, ".protein.aliases.v11.5.txt.gz")
...
inters_file <- paste0("assests:/i_data/", species, ".protein.links.v11.5.txt.gz")
...
map_to_stringids <- function(filtUserData, mapping_db = mapping_db){
  mapping <- dplyr::filter(mapping_db, mapping_db$alias %in% filtUserData$Protein_Identifier)
